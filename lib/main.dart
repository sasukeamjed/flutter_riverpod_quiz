...
//Question:
// 1- what is HtmlCharacterEntities
// 2- what is flexible widget
// 3- check what is SizedBox.shrink()
...
class AnswerCard extends StatelessWidget {
  ...
  const AnswerCard(
      {Key key, @required this.answer, @required this.isSelected, @required this.isCorrect, @required this.isDisplayingAnswer, @required this.onTap})
      : super(key: key);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: boxShadow,
          border: Border.all(
            color: isDisplayingAnswer ? isCorrect ? Colors.green : isSelected
                ? Colors.red
...
class CircularIcon extends StatelessWidget {
  ...
  const CircularIcon({Key key, this.icon, this.color}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      height: 24.0,
